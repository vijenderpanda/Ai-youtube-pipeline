...
## Backfill 2026-07-24
<!-- Pegs the 3h RSS radar missed but the factory's own planning record dates
     (llm-stats.com, as cited in the Aug-6 suggestion cycle). Backfilled so
     `--peg-check` can date the stories that caused the dcf956d5 / 14d5fed6
     stale-peg challenges. Dates are first-report dates, not discovery dates. -->
- Claude Opus 5 takes the benchmark lead — Anthropic's 4th model in under two months

## Backfill 2026-07-30
- OpenAI cuts GPT-5.6 API prices up to 80% — Luna tier down to $0.20/$1.20 per 1M tokens

## Backfill 2026-07-31
- DeepSeek-V4-Flash enters public beta at $0.14/$0.28 per 1M tokens with MIT-licensed open weights

## Backfill 2026-08-02
- Alibaba ships Qwen3.8-Max to GA — 2.4T params at $2/$6 per 1M tokens

## Backfill 2026-08-04
- UK safety evaluations document 19 instances of frontier models (Mythos, GPT-5.6 Sol) attempting cyberattack-like behavior

## Backfill 2026-08-05
- Federal appeals court overturns Amazon's injunction against Perplexity's AI shopping agent — ruling that the USER, not the startup, is the one accessing the platform
- AI system created fake identities and attempted social engineering during UK safety tests, uninstructed; Anthropic and OpenAI agents went rogue again the same day

## Radar 2026-08-01 23:52
...
## Peg Checks
<!-- appended by news_radar.py --peg-check; audit trail, NOT radar history -->
<!-- 2026-08-06 rows below are the gate's own verification run, not real episodes -->
- PEG-CHECK 2026-08-06 17:26 | peg="GPT-5.6 price cut" | air=2026-08-06 | first_seen=2026-07-30 | age=7d | limit=4d | STALE
- PEG-CHECK 2026-08-06 17:26 | peg="Perplexity Amazon ruling" | air=2026-08-07 | first_seen=2026-08-05 | age=2d | limit=4d | FRESH
- PEG-CHECK 2026-08-06 17:26 | peg="safety tests cyberattack instances" | air=2026-08-10 | first_seen=2026-08-04 | age=6d | limit=4d | STALE
- PEG-CHECK 2026-08-06 17:26 | peg="Nvidia quantum chip launch" | air=2026-08-07 | first_seen=? | age=?d | limit=4d | UNVERIFIED
- PEG-CHECK 2026-08-06 17:27 | peg="Perplexity Amazon ruling" | air=2026-08-07 | first_seen=2026-08-05 | age=2d | limit=4d | FRESH

## Radar 2026-08-06 17:28
...
- PEG-CHECK 2026-08-06 18:19 | peg="AI created fake identities social engineering safety tests" | air=2026-08-10 | first_seen=2026-08-05 | age=5d | limit=4d | STALE
- PEG-CHECK 2026-08-06 18:59 | peg="EU AI Act Article 50 transparency labels in force not deferred" | air=2026-08-12 | first_seen=? | age=?d | limit=4d | UNVERIFIED
- PEG-CHECK 2026-08-06 19:23 | peg="Appeals court overturns Amazon injunction against Perplexity AI shopping agent" | air=2026-08-06 | first_seen=2026-08-05 | age=1d | limit=4d | FRESH

## Radar 2026-08-06 20:59
...
- PEG-CHECK 2026-08-06 21:01 | peg="DeepSeek-V4-Flash price /bin/zsh.14 per 1M tokens China price war" | air=2026-08-07 | first_seen=? | age=?d | limit=4d | UNVERIFIED
- PEG-CHECK 2026-08-06 21:01 | peg="DeepSeek-V4-Flash cheap pricing China AI price war" | air=2026-08-07 | first_seen=? | age=?d | limit=4d | UNVERIFIED

## Radar 2026-08-06 23:59
