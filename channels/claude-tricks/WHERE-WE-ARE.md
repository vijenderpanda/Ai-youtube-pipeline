...
| ep3 `anydoc` | Stop Pasting Messy PDFs Into AI — AnyDoc Fixes It 📄 | 17:30 IST **Aug 26** (swapped back) | ARMED | youtu.be/o6LMLggOh_I |
| ep4 `hfagents` | This Free AI Agents Course Certifies You 🤖 | **17:30 IST Aug 25** | **ARMED** — full look + tightened VO + cert-first chip | youtu.be/YsCdwiKJUf8 |
