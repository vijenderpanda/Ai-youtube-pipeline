...
- **Publish cadence (VJ directive 2026-08-14, supersedes 2026-08-13): the SERIES runs as a ONE-WEEK SEASON on the three proven days — chapters Mon/Tue/Thu + Friday finale/showcase, all at 16:00 IST; WEDNESDAY IS DARK** (the 12-day read: everything is decided in 24–48h so weekly chapters restarted from zero; Mon/Tue/Thu measured d0 147/91 · 165/132 · 129 while Wed measured the day-after crash 25/5 — see docs/stats/AI-UNPACKED-READ-2026-08-14.md). Season promise: start Monday, LISTED by Thursday evening, Friday you watch it compound. Planners must not book uploads on a dark Wednesday during a season week, and 16:00 IST stays fixed — it is the only tested slot time; day-structure and slot-time are never changed in the same experiment. The spoken outro is DAY-AWARE (`outro_cta.py`): a Thursday episode hands off to the Friday series ("Tomorrow is Friday — meet me there"), other days tease the next episode ONLY when it genuinely publishes tomorrow, else the series promise. When shifting the schedule, move the WHOLE chain together (armed publishAt + factory_posts.publish_at + calendar planned_date) so consecutive days stay consecutive.
